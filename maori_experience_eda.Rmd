...
Seems like people who have difficulties in hearing, memory and walking are more likely to experience Maori culture (except for cannot do at all, which has very low value count). This is quite surprising, but perhaps people who don't have difficulties are more likely to prefer other activities.
...
We can deduce travel_alone from the other two columns, so we will drop it later when modelling.
